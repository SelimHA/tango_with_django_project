...
#Note program begins at bottom
def populate():
    
    python_pages = [
    {'title': 'Official Python Tutorial','url':'http://docs.python.org/3/tutorial/', 'views':'52'},
    {'title':'How to Think like a Computer Scientist','url':'http://www.greenteapress.com/thinkpython/', 'views':'545'},
    ...
    {'title':'Django Rocks','url':'http://www.djangorocks.com/', 'views':'456'},
    ...
    {'title':'Flask','url':'http://flask.pocoo.org', 'views':'102'} ]
